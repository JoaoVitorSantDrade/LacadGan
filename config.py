...
PATIENCE_DECAY = 10
BATCH_SIZES = [128, 64, 32, 32, 16, 4, 2, 1, 1] # 4 8 16 32 64 128 256 512 1024
IMAGE_SIZE = 256
CHANNELS_IMG = 3
SIMULATED_STEP = 7
...
NUM_WORKERS = int(os.cpu_count()) #Demora mto para carregar e o dataset n é grande pra valer a pena
