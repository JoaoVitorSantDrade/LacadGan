...
LEARNING_RATE_GENERATOR = 7e-4 #0.001
LEARNING_RATE_DISCRIMINATOR = 6e-4 #0.0006
WEIGHT_DECAY = 3e-6 #0.000003
BATCH_SIZES = [128, 64, 64, 32, 16, 8, 4, 2, 1] # 4 8 16 32 64 128 256 512 1024
IMAGE_SIZE = 512
CHANNELS_IMG = 3
...
PROGRESSIVE_EPOCHS = [55] * len(BATCH_SIZES) # Pra cada tamanho de imagem | 30 -> 4H numa GT 1030
